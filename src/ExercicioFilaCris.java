...
public class ExercicioFilaCris {
    ...
    ArrayList<String> contatoCliente = new ArrayList<String>();
    ArrayList<String> enderecoCliente = new ArrayList<String>();
    ...
    public static void main(String[] args) {
        ...
        ExercicioFilaCris filaCallCenter = new ExercicioFilaCris();
